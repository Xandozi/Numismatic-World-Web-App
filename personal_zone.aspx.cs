...
namespace Numismatica
{
    public partial class personal_zone : System.Web.UI.Page
    {
        ...
        protected void btn_change_pw_Click(object sender, EventArgs e)
        {
            ...
            if (Validacao.Check_Login(Session["username"].ToString(), tb_pw.Text) == 1 && tb_new_pw.Text == tb_new_pw_repeat.Text && tb_new_pw.Text != tb_pw.Text && tb_new_pw_repeat.Text != tb_pw.Text)
            {
                Insercao.Update_Password(Extract.Email(Session["username"].ToString()), Validacao.EncryptString(tb_new_pw.Text));
        ...
        // Exportação da colecção do utilizador para PDF
        ...
        {
            if (Validacao.Check_Login(Session["username"].ToString(), tb_pw_username.Text) == 1 && Session["username"].ToString() != tb_new_username.Text)
            {
        ...
        {
            if (Validacao.Check_Login(Session["username"].ToString(), tb_pw_email.Text) == 1 && Session["email"].ToString() != tb_new_email.Text)
            {
