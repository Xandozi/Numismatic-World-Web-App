<%@ Page Title="" Language="C#" MasterPageFile="~/numismatica.Master" AutoEventWireup="true" CodeBehind="coins.aspx.cs" Inherits="Numismatica.coins" %>
        ...
        <div class="col-md-9" style="max-width: 100%;">
            ...
            <div id="viewCoinsDiv" style="margin-top: 20px;">
                <div class="card-header" style="background-color: #333; color: #fff; margin-bottom: -5px;">
                    <h2 class="display-4" style="font-size: 40px;">Coin Catalog</h2>
                </div>
